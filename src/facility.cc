...
GridPoint rotateDirection(GridPoint direction, Rotation rotation) {
    switch (rotation) {
...
bool isLogisticsFacility(FacilityCategory category) {
...
bool ignoresPowerCoverage(FacilityCategory category) {
...
bool defaultRequiresPower(const FacilityDefinition& definition) {
    if (definition.category == FacilityCategory::Chest) {
        return true;
    }
    if (definition.role == FacilityRole::Production_facility) {
        return true;
    }
    if (definition.role == FacilityRole::Chest) {
        return true;
    }
    return false;
}

PowerFacilityType defaultPowerFacilityType(FacilityCategory category) {
    switch (category) {
